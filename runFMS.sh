...
SERVER_MODULE="familymapserver"

#"com.example" is the package name.
#"Server" would be the class with the main function.
PACKAGE_NAME_TO_MAIN="handler.FM_Server"
PACKAGE_NAME_TO_TEST_DRIVER="server.TestDriver"
LIBS_FOLDER="familymapserver/libs"

CODE_LOC="$SERVER_MODULE/src/main/*"
TEST_CODE_LOC="$SERVER_MODULE/src/*"
